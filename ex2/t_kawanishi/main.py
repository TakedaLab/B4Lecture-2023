...
if __name__ == "__main__":
    ...
    F.show_spectrogram(data,overlap_r=overlap_r,Fs=Fs,y_lim=spec_y_lim,s_name="origin")
    F.show_spectrogram(filtered_data,overlap_r = overlap_r, Fs=Fs,y_lim=spec_y_lim, s_name="filtered")
